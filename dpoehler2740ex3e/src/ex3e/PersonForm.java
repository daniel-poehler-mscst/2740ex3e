...
//	private PrintWriter outputFile;
	...
	public PersonForm() {
		...
		setTitle("Ex3E: Ch5 modify 2C: static members");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 520, 210);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		...
		// Open the file
//		this.outputFile = new PrintWriter("PersonDate.txt");
		boolean fileIsOpen = Person.openFile("PersonDate.txt");
		if (!fileIsOpen) {
	...
	protected void do_personButton_actionPerformed(ActionEvent e) {
		...
		// Output to file
		person.write();
		//this.outputFile.println(person.getName());
